...
export function switchProjectInfoTab(tabId) {
    ...
    btns.forEach(b => {
        ...
        if (isActive) {
            ...
            b.style.borderBottomColor = '#2196F3';
    ...
    panes.forEach(p => {
        if (p.id === `info-tab-${tabId}`) p.style.display = 'block';
